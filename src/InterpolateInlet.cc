...
PetscErrorCode InterpolateProfiles(PetscReal hy, PetscInt my,
  ...
  std::vector<double> y_init { 1.000, 1.100, 1.150, 1.200, 1.300, 1.400,
    1.500, 1.700, 2.000, 2.400, 2.800, 3.200,
    3.600, 4.000, 5.000, 6.000, 7.500, 8.200,
    9.000};

  std::vector<double> u_init { 0.000, 0.700, 0.729, 0.757, 0.794, 0.825,
    0.853, 0.895, 0.947, 0.998, 1.020, 1.019,
    1.016, 1.014, 1.009, 1.007, 1.007, 0.940,
    0.000};

  std::vector<double> v_init { 0.000, -0.017, -0.017, -0.020, -0.020, -0.020,
    -0.022, -0.023, -0.022, -0.020, -0.017, -0.016,
    -0.016, -0.017, -0.022, -0.020, -0.022, -0.015,
    0.000};

  std::vector<double> y_exit { 0.000, 0.100, 0.150, 0.200, 0.300, 0.400,
  ...
  std::vector<double> u_exit { 0.000, 0.581, 0.604, 0.621, 0.645, 0.662,
  ...
  std::vector<double> v_exit { 0.000, -0.005, -0.004, -0.004, -0.005, -0.004,
